  ...
  return (
    <main styles={styles["main-container"]}>
      <header>
        ...
        <p ref={gearLibraryBanner} className={['text-center py-2 px-3 bg-secondary-dark/80 text-md sm:text-lg md:text-2xl text-white z-10', styles["contact-banner"]].join(" ")}>Contact us at <a className='underline' href="mailto:info@openoutdoorsvictoria.ca">info@openoutdoorsvictoria.ca</a> to borrow gear!</p>
      </header>
