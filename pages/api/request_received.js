...
import { REQUEST_RECEIVED_EMAIL_CONTENTFUL_ID } from "../../src/server/contentful_management_client";
...
async function handler(req, res) {
  ...
  let { subject, htmlEmailBody } = await buildEmailContent(REQUEST_RECEIVED_EMAIL_CONTENTFUL_ID, { name: req.body.name })
